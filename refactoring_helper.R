...
function_mappings <- c(
  ...
  "coherenceEstratoRimGear" = "coherence_rim_stratum_gear",
  ...
  "fixTALL.PESOVariable" = "fix_length_weight_variable",
  "checkTALL.PESO" = "check_length_weight_variable",
  "checkSexedSpecies" = "check_sexed_species",
  "checkNoSexedSpecies" = "check_no_sexed_species",
  "checkMultipleEstratoRIM" = "check_multiple_rim_stratum",
  "checkMultipleGear" = "check_multiple_gear",
  "checkMultiplePort" = "check_multiple_port",
  "checkCoherenceEstratoRimOrigin" = "check_coherence_rim_stratum_origin",
